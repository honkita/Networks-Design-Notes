...
\begin{multicols*}{5}
  ...
  \definition{IETF}{Internet Engineering Task Force}
  ...
  \begin{multicols*}{2}
    ...
    \definition{AN}{Access Network}
    
    \definition{CHF}{Charging Function}
    
    \definition{CUPS}{Control and User Plane Separation}
    
    \definition{DCS}{Data Communication System}
    
    \definition{DN}{Data Network}
    
    \definition{EIR}{Equipment Identity Register}
  ...
  \begin{center}
    \begin{tikzpicture}[
      ...
      % Client steps
      \draw[rounded corners, dashed] (-1, -4.25) rectangle (-2.5, 1.75);
      \node[font=\bfseries, align=center, text width = 1cm] (client) at (-1.75, 1.5) {UDP Client};
      \node[align=center, text width=1cm, draw, rounded corners] (clientSocket) at (-1.75, 1) {socket()};
      \node[align=center, text width=1cm, draw, rounded corners] (clientSend) at (-1.75, -2) {sendto()};
      \node[align=center, text width=1cm, draw, rounded corners] (clientReceive) at (-1.75, -3) {recvfrom()};
      \node[align=center, text width=1cm, draw, rounded corners] (clientClose) at (-1.75, -4) {close()};
      ...
      % Server steps
      \draw[rounded corners, dashed] (1, -4.25) rectangle (2.5, 1.75);
      \node[font=\bfseries, align=center] (server) at (1.75, 1.5) {UDP Server};
      \node[align=center, text width=1cm, draw, rounded corners] (serverSocket) at (1.75, 1){socket()};
      \node[align=center, text width=1cm, draw, rounded corners] (serverBind) at (1.75, 0){bind()};
      \node[align=center, text width=1cm, draw, rounded corners] (serverReceive) at (1.75, -1){recvfrom()};
      \node[align=center, text width=1cm, draw, rounded corners] (serverSend) at (1.75, -3){sendTo()};
      
      % Arrows
      \draw[->] (serverSocket) -- (serverBind);
      \draw[->] (serverBind) -- (serverReceive);
      
      \node[align=center, text width=0.75cm, draw, rounded corners] (block) at (1.5, -2) {Block until datagram received};
      
      \draw[->] ([xshift=0.25cm]serverSend.north) -- ([xshift=0.25cm]serverReceive.south);
      
      \node[align=center] (datareq) at (0, -2){data(request)};
      \draw[->] (clientSend) -- (datareq) -- (block);
      \draw[-] ([xshift=-0.25cm]serverReceive.south) -- (block);
      \draw[->] (block) -- ([xshift=-0.25cm]serverSend.north);
      
      \node[align=center] (datarep) at (0, -3){data(reply)};
      \draw[->] (serverSend) -- (datarep) -- (clientReceive);
    \end{tikzpicture}
  ...
  \begin{center}
    \begin{tikzpicture}[
      ...
      \draw[rounded corners, dashed] (-1, -7.25) rectangle (-2.5, 1.75);
      \node[font=\bfseries, align=center, text width = 1cm] (client) at (-1.75, 1.5) {TCP Client};
      
      \node[align=center, text width=1cm, draw, rounded corners] (clientSocket) at (-1.75, 1) {socket()};
      \node[align=center, text width=1cm, draw, rounded corners] (clientConnect) at (-1.75, -3) {connect()};
      \node[align=center, text width=1cm, draw, rounded corners] (clientWrite) at (-1.75, -4) {write()};
      \node[align=center, text width=1cm, draw, rounded corners] (clientRead) at (-1.75, -5) {read()};
      \node[align=center, text width=1cm, draw, rounded corners] (clientClose) at (-1.75, -6) {close()};
      
      \draw[->] (clientSocket) -- (clientConnect);
      \draw[->] (clientConnect) -- (clientWrite);
      \draw[->] ([xshift=-0.25cm]clientWrite.south) -- ([xshift=-0.25cm]clientRead.north);
      \draw[->] ([xshift=0.25cm]clientRead.north) -- ([xshift=0.25cm]clientWrite.south);
      \draw[->] (clientRead) -- (clientClose);
      
      % Server steps
      \draw[rounded corners, dashed] (1, -7.25) rectangle (2.5, 1.75);
      \node[font=\bfseries, align=center, text width = 1cm] (server) at (1.75, 1.5) {TCP Server};
      \node[align=center, text width=1cm, draw, rounded corners] (serverSocket) at (1.75, 1) {socket()};
      \node[align=center, text width=1cm, draw, rounded corners] (serverBind) at (1.75, 0) {bind()};
      \node[align=center, text width=1cm, draw, rounded corners] (serverListen) at (1.75, -1) {listen()};
      \node[align=center, text width=1cm, draw, rounded corners] (serverAccept) at (1.75, -2) {accept()};
      \node[align=center, text width=1cm, draw, rounded corners] (block) at (1.75, -3) {Blocks until client connected};
      \node[align=center, text width=1cm, draw, rounded corners] (serverRead1) at (1.75, -4) {read()};
      \node[align=center, text width=1cm, draw, rounded corners] (serverWrite) at (1.75, -5) {write()};
      \node[align=center, text width=1cm, draw, rounded corners] (serverRead2) at (1.75, -6) {read()};
      \node[align=center, text width=1cm, draw, rounded corners] (serverClose) at (1.75, -7) {close()};
      
      \draw[->] (serverSocket) -- (serverBind);
      \draw[->] (serverBind) -- (serverListen);
      \draw[->] (serverListen) -- (serverAccept);
      \draw[->] ([xshift=-0.25cm]serverRead1.south) -- ([xshift=-0.25cm]serverWrite.north);
      \draw[->] ([xshift=0.25cm]serverWrite.north) -- ([xshift=0.25cm]serverRead1.south);
      \draw[->] (serverWrite) --(serverRead2);
      \draw[->] (serverRead2) -- (serverClose);
      
      \draw[->] (serverAccept) -- (block) --(serverRead1);
      
      \node[align=center] (tcpconnection) at (0, -3) {TCP Connection};
      
      \draw[->] (tcpconnection) -- (block);
      \draw[->] (tcpconnection) -- (clientConnect);
      
      \node[align=center] (datareq) at (0, -4) {data(request)};
      \draw[->] (clientWrite) -- (datareq) -- (serverRead1);
      
      \node[align=center] (datarep) at (0, -5) {data(reply)};
      \draw[->] (serverWrite) -- (datarep) -- (clientRead);
      
      \node[align=center] (eof) at (0, -6) {EOF Notification};
      \draw[->] (serverRead2) -- (eof) -- (clientClose);
...
\begin{multicols*}{3}
  ...
  \subsection{LTE/5G Non-Standalone}
  
  \begin{center}
    \begin{tabular}{| m{1cm} | m{1cm} | m{6cm} |}
      \hline
      \textbf{S1-U}   & \textbf{eNB} \& \textbf{UPF} & Routes and forwards user data packets. Replaced by \textbf{N3}                                              \\
      \hline
      \textbf{S1-MME} & \textbf{eNB} \& \textbf{MME} & Facilitates control plane signaling, including mobility management, session management, and authentication. \\
      \hline
    \end{tabular}
  \end{center}
  ...
  \begin{center}
    \begin{tabular}{| m{0.5cm} | m{1.5cm} | m{6cm} |}
      \hline
      \textbf{N1}  & \textbf{UE} \& \textbf{AMF}      & Handles registration, authentication, and mobility management procedures.                   \\
      \hline
      \textbf{N2}  & \textbf{(R)AN} \& \textbf{AMF}   & Carries signaling and data between the \textbf{RAN} and the core network.                   \\
      \hline
      \textbf{N3}  & \textbf{(R)AN} \& \textbf{UPF}   & Facilitates transfer of user data between \textbf{RAN} and core network.                    \\
      \hline
      \textbf{N4}  & \textbf{SMF} \& \textbf{UPF}     & Responsible for session management and data flow control.                                   \\
      \hline
      \textbf{N5}  & \textbf{PCF} \& \textbf{AF}      & Handles policy enforcement and authentication.                                              \\
      \hline
      \textbf{N6}  & \textbf{UPF} \& \textbf{DN}      & Responsible for transferring user data to and from external networks.                       \\
      \hline
      \textbf{N7}  & \textbf{PCF} \& \textbf{SMF}     & Triggers session management policies.                                                       \\
      \hline
      \textbf{N16} & \textbf{V-SMF} \& \textbf{H-SMF} & Connects Visited SMF that exists in the PLMN and the Home SMF that exists in the Home PLMN. \\
      \hline
      \textbf{N26} & \textbf{MME} \& \textbf{AMF}     & Crucial for facilitating communication between 4G/LTE EPC and 5GS                           \\
      \hline
    \end{tabular}
  \end{center}
  ...
  \begin{itemize}
    \item Refers to the network's core
    \item Responsible for managing and interconnecting other parts of the network
  \end{itemize}
  ...
  \begin{center}
    ...
    \begin{tikzpicture}[
      ...
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (0, 3) (nssf) {NSSF};
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (2, 3) (nwdaf) {NWDAF};
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (3, 3) (udr) {UDR};
      
      \node[align=center, text width=0.75cm, draw, minimum width=0.6cm, font=\bfseries] at (4, 3) (chf) {CHF};
      
      % Row 2
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (-2, 2) (udm) {UDM};
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (1, 2) (af) {AF};
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, minimum height=0.6cm, font=\bfseries] at (3, 2) (pcf) {PCF};
      
      
      % Row 3
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (-2, 1) (nssaaf) {NSSAAF};
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (-1, 1) (smsf) {SMSF};
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (1, 1) (ucmf) {UCMF};
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (2, 1) (nef) {NEF};
      
      
      % Row 4
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (-2, 0) (ausf) {AUSF};
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, minimum height=0.6cm, font=\bfseries] at (0, 0) (amf) {AMF};
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, minimum height=0.6cm, font=\bfseries] at (4, 0) (smf) {SMF};
      
      
      % Row 5
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (-2, -1) (mme) {MME};
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (2, -1) (cbcf) {CBCF};
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (3, -1) (upf) {UPF};
      
      
      % Row 6
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (-2, -2) (ue) {UE};
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (0, -2) (ran) {(R)AN};
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (1, -2) (eir) {EIR};
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (2, -2) (dn) {DN};
      
      \node[align=center, text width=0.6cm, draw, minimum width=0.6cm, font=\bfseries] at (3, -2) (nrf) {NRF};
      ...
      \node[align=center] at (-1, -1) (n1) {N1};
      \draw[-] (ue) -- (n1) -- (amf);
      
      \node[align=center] at (0, -1) (n2) {N2};
      \draw[-] (amf) -- (n2) -- (ran);
      
      \node[align=center] at (4.5, -2.5) (n3) {N3};
      \draw[-] (upf) -| (n3) -| (ran);
      
      \node[align=center] at (3.5, -0.5) (n4) {N4};
      \draw[-] (smf) -- (n4) -- (upf);
      
      \node[align=center] at (2, 2) (n5) {N5};
      \draw[-] (af) -- (n5) -- (pcf);
      
      \node[align=center] at (2.5, -1.5) (n6) {N6};
      \draw[-] (upf) -- (n6) -- (dn);
      
      \node[align=center] at (4, 2.05) (n7) {N7};
      \draw[-] (smf) -- (n7) -- ([yshift=0.05cm]pcf.east);
      
      \node[align=center] at (-0.1, 2) (n8) {N8};
      \draw[-] (udm) -- (n8) -- ([xshift=-0.1cm]amf.north);
      
      \node[align=center] at (3, -1.5) (n9) {N9};
      \draw[-] (n9) -- (upf);
      
      \node[align=center] at (4.5, 3.5) (n10) {N10};
      \draw[-] ([xshift=0.25cm]udm.north) |- (n10) |- ([yshift=-0.05cm]smf.east);
      
      \node[align=center] at (2, -0.15) (n11) {N11};
      \draw[-] ([yshift=-0.15cm]amf.east) -- (n11) -- ([yshift=-0.15cm]smf.west);
      
      \node[align=center] at (-1, 0) (n12) {N12};
      \draw[-] (ausf) -- (n12) -- (amf);
      
      \node[align=center] at (-3, 3.5) (n13) {N13};
      \draw[-] (ausf) -| (n13) -| ([xshift=-0.25cm]udm.north);
      
      \node[align=center] at (-0.5, -1) (n14) {N14};
      \draw[-] (amf) -- (n14);
      
      \node[align=center] at (3, 0.0) (n15) {N15};
      \draw[-] ([yshift=0.00cm]amf.east) -- (n15) -- (pcf);
      
      \node[align=center] at (3, -0.5) (n16) {N16};
      \draw[-] (smf) -- (n16);
      
      \node[align=center] at (0.5, -1) (n17) {N17};
      \draw[-] (eir) -- (n17) -- (amf);
      
      \node[align=center] at (-0.5, 0.5) (n20) {N20};
      \draw[-] (smsf) -- (n20) -- (amf);
      
      \node[align=center] at (-1.5, 1.5) (n21) {N21};
      \draw[-] (udm) -- (n21) -- (smsf);
      
      \node[align=center] at (0.1, 1) (n22) {N22};
      \draw[-] ([xshift=0.1cm]nssf.south) -- (n22) -- ([xshift=0.1cm]amf.north);
      
      \node[align=center] at (2.5, 2.5) (n23) {N23};
      \draw[-] (nwdaf) -- (n23) -- (pcf);
      
      \node[align=center] at (-1, -0.5) (n26) {N26};
      \draw[-] (mme) -- (n26) -- (amf);
      
      \node[align=center] at (4, -2) (n27) {N27};
      \draw[-] (nrf) -- (n27);
      
      \node[align=center] at (3.5, 2.5) (n28) {N28};
      \draw[-] (chf) -- (n28) -- (pcf);
      
      \node[align=center] at (2.5, 1.5) (n30) {N30};
      \draw[-] (nef) -- (n30) -- (pcf);
      
      \node[align=center] at (1.5, 1.5) (n33) {N33};
      \draw[-] (af) -- (n33) -- (nef);
      
      \node[align=center] at (1, 3) (n34) {N34};
      \draw[-] (nssf) -- (n34) -- (nwdaf);
      
      \node[align=center] at (3, 2.5) (n36) {N36};
      \draw[-] (udr) -- (n36) -- (pcf);
      
      \node[align=center] at (4.25, 1.5) (n40) {N40};
      \draw[-] ([xshift=0.25cm]smf.north) -- (n40) -- ([xshift=0.25cm]chf.south);
      
      \node[align=center] at (1, -0.5) (n50) {N50};
      \draw[-] (amf) -- (n50) -- (cbcf);
      
      \node[align=center] at (2, 0.15) (n51) {N51};
      \draw[-] (nef) -- (n51) -- ([yshift=0.15cm]amf.east);
      
      \node[align=center] at (0.5, 0.5) (n55) {N55};
      \draw[-] (amf) -- (n55) -- (ucmf);
      
      \node[align=center] at (1.5, 0.5) (n56) {N56};
      \draw[-] (nef) -- (n56) -- (ucmf);
      
      \node[align=center] at (1, 1.5) (n57) {N57};
      \draw[-] (af) -- (n57) -- (ucmf);
      
      \node[align=center] at (-1, 0.5) (n58) {N58};
      \draw[-] (amf) -- (n58) -- (nssaaf);
      
      \node[align=center] at (-2, 1.5) (n59) {N59};
      \draw[-] (udm) -- (n59) -- (nssaaf);
      
    \end{tikzpicture}
  \end{center}
  
  \section{NETCONF Protocol Stack}
  
  \begin{itemize}
    \item Provides a secure wat to manage and configure network devices such as routers and switches
    \item Standardized by the \textbf{IETF}
  \end{itemize}
  ...
  \begin{center}
    ...
    \begin{tikzpicture}[
      ...
      \node[text width=1cm, font=\bfseries] at (1.75, -2.25) (graphite) {GRAPHITE};
      
      \draw[rounded corners] (1.25, 0.75) rectangle (4.25, -0.5);
      
      \node[align=center, text width=1cm, font=\bfseries] at (2.75, 0.5) (carbon) {CARBON};
  ...
  \begin{center}
    ...
    \begin{tikzpicture}[
      ...
      \node[below left = 0.25cm and 0.25cm of promql, align=center, text width=2cm, draw, rounded corners](webui) {Prometheus Web UI};
      ...
      \node[font=\bfseries, align=center, text width=2.25cm] (datavisualization) at (1.25, -2) {Data Visualization\\and Export};
      ...
      \draw[-] (webui.east) -| ([xshift=-0.25cm] promql.south);
      \draw[-] (grafana.east) -| (promql.south);
      \draw[-] (api.east) -| ([xshift=0.25cm]promql.south);
