...
\begin{multicols*}{3}
  ...
  \begin{center}
    ...
    \begin{tikzpicture}[
      ...
      % Row 1.5
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (-1.5, 1) (nssf) {NSSF};
      
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (0.5, 1) (smsf) {SMSF};
      
      \node[align=center] at (0.5, 1.5) (n21) {N21};
      \draw[-] (udm) -- (n21) -- (smsf);
      ...
      \node[align=center] at (-1, 0.5) (n22) {N22};
      \draw[-] (nssf) -- (n22) -- (amf);
      
      \node[align=center] at (0, 0.5) (n20) {N20};
      \draw[-] (smsf) -- (n20) -- (amf);
      ...
      \node[align=center] at (-1.75, -1) (n1) {N1};
      \draw[-] ([xshift=-0.25cm]ue.north) -- (n1) -- ([xshift=-0.25cm]amf.south);
