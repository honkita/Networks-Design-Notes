...
\begin{multicols*}{3}
  ...
  \begin{center}
    ...
    \begin{tikzpicture}[
      ...
      % Row 1
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (-2.5, 2) (nef) {NEF};
      
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (-1.5, 2) (nrf) {NRF};
      
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (-0.5, 2) (udm) {UDM};
      
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (1.5, 2) (af) {AF};
      
      % Row 2
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (-2.5, 1) (nssf) {NSSF};
      
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (-1.5, 1) (smsf) {SMSF};
      
      \node[align=center] at (-1, 1.5) (n21) {N21};
      \draw[-] (udm) -- (n21) -- (smsf);
      
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (0.5, 1) (nssaaf) {NSSAAF};
      
      \node[align=center] at (0, 1.5) (n59) {N59};
      \draw[-] (udm) -- (n59) -- (nssaaf);
      
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (1.5, 1) (pcf) {PCF};
      
      \node[align=center] at (1.5, 1.5) (n5) {N5};
      \draw[-] (af) -- (n5) -- (pcf);
      
      % Row 3
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (-2.5, 0) (ausf) {AUSF};
      
      \node[align=center] at (-3.5, 2.5) (n13) {N13};
      \draw[-] (ausf) -| (n13) -| ([xshift=-0.25cm]udm.north);
      
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (-0.5, 0) (amf) {AMF};
      
      \node[align=center] at (0, -0.5) (n14) {N14};
      \draw[-] (amf) -- (n14);
      
      \node[align=center] at (-1.5, 0.5) (n22) {N22};
      \draw[-] (nssf) -- (n22) -- (amf);
      
      \node[align=center] at (-1, 0.5) (n20) {N20};
      \draw[-] (smsf) -- (n20) -- (amf);
      
      \node[align=center] at (-0.5, 1) (n8) {N8};
      \draw[-] (udm) -- (n8) -- (amf);
      
      \node[align=center] at (-1.5, 0) (n12) {N12};
      \draw[-] (ausf) -- (n12) -- (amf);
      
      \node[align=center] at (0, 0.5) (n58) {N58};
      \draw[-] (amf) -- (n58) -- (nssaaf);
      
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (1.5, 0) (smf) {SMF};
      
      \node[align=center] at (1.5, 0.5) (n7) {N7};
      \draw[-] (smf) -- (n7) -- (pcf);
      
      \node[align=center] at (0.5, 0) (n11) {N11};
      \draw[-] (amf) -- (n11) -- (smf);
      
      \node[align=center] at (2.5, 2.5) (n10) {N10};
      \draw[-] ([xshift=0.25cm]udm.north) |- (n10) |- (smf);
      
      % Row 4
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (-2.5, -1) (mme) {MME};
      
      \node[align=center] at (-1.5, -0.5) (n26) {N26};
      \draw[-] (mme) -- (n26) -- (amf);
      
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (1.5, -1) (upf) {UPF};
      
      \node[align=center] at (2.5, -1) (n9) {N9};
      \draw[-] (n9) -- (upf);
      
      \node[align=center] at (1.5, -0.5) (n4) {N4};
      \draw[-] (smf) -- (n4) -- (upf);
      
      % Row 5
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (-2.5, -2) (ue) {UE};
      
      \node[align=center] at (-1.5, -1) (n1) {N1};
      \draw[-] (ue) -- (n1) -- (amf);
      
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (-0.5, -2) (ran) {(R)AN};
      
      \node[align=center] at (-0.5, -1) (n2) {N2};
      \draw[-] (amf) -- (n2) -- (ran);
      
      \node[align=center] at (0.5, 0.5) (n15) {N15};
      \draw[-] (amf) -- (n15) -- (pcf);
      
      \draw[-] (ue) -- (ran);
      
      \node[align=center, text width=0.75cm, draw, rounded corners, minimum width=0.75cm, font=\bfseries] at (1.5, -2) (dn) {DN};
      
      \node[align=center] at (0.5, -1.5) (n3) {N3};
      \draw[-] (upf) -- (n3) -- (ran);
      
      \node[align=center] at (1.5, -1.5) (n6) {N6};
      \draw[-] (upf) -- (n6) -- (dn);
