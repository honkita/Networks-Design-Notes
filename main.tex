...
\begin{multicols*}{5}
  ...
  \definition{CENELEC}{European Committee for Electrotechnical Standardization}
  ...
  \begin{itemize}
    ...
    \item Similar to a transport-layer reliable delivery service, a link-layer reliable delivery service can be achieved with acknowledgments and retransmissions
    \item Similar to a transport-layer reliable delivery service, a link-layer reliable delivery service can be achieved with acknowledgments and retransmissions
  ...
  \begin{multicols*}{2}
    ...
    \begin{itemize}
      \item Having less bandwidth = losing some of the harmonics
