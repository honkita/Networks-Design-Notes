...
\begin{multicols*}{3}
  ...
  \begin{center}
    \begin{tabular}{| m{1cm} | m{1cm} | m{6cm} |}
      ...
      \hline
      \textbf{S1-MME} & \textbf{eNB} \& \textbf{MME} & Facilitates control plane signaling, including mobility management, session management, and authentification. \\
      \hline
    \end{tabular}
  \end{center}
  ...
  \begin{center}
    \begin{tabular}{| m{1cm} | m{1cm} | m{6cm} |}
      ...
      \hline
      \textbf{N5} & \textbf{PCF} \& \textbf{AF}    & Handles policy enforcement and authentification.                          \\
      \hline
